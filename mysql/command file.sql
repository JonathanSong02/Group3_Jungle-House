...
VALUES
('Kiosk Closing Check List', 'Check stock, clean kiosk, prepare equipment before opening.', 'SOP'),
('Aeon Roadshow Closing List', 'Close cash, clean area, store products properly.', 'SOP'),
('Aeon Roadshow Opening List', 'Wild honey has natural benefits and is rich in nutrients.', 'PRODUCT'),
('JHKC Kiosk Opening', 'Greet customer, explain benefits, recommend suitable product.', 'SALES'),
('Backend Opening Checklist', 'Check stock, clean kiosk, prepare equipment before opening.', 'SOP'),
('Closing Spring Warehouse', 'Close cash, clean area, store products properly.', 'SOP'),
('Kuching Booth Closing dustbin check list', 'Wild honey has natural benefits and is rich in nutrients.', 'PRODUCT'),
('Opening Notes', 'Greet customer, explain benefits, recommend suitable product.', 'SALES'),
('Receipt printer preparation for opening', 'Check stock, clean kiosk, prepare equipment before opening.', 'SOP'),
('Sales Closing Reminders Material', 'Close cash, clean area, store products properly.', 'SOP'),
('Shopify POS app Closing', 'Wild honey has natural benefits and is rich in nutrients.', 'PRODUCT'),
('Shopify POS app Opening', 'Greet customer, explain benefits, recommend suitable product.', 'SALES'),
('Spring Roadshow Closing List', 'Check stock, clean kiosk, prepare equipment before opening.', 'SOP'),
('Spring Roadshow Opening List', 'Close cash, clean area, store products properly.', 'SOP'),
('Win the Heart Gift Guide', 'Wild honey has natural benefits and is rich in nutrients.', 'PRODUCT'),
('Promotions', 'Greet customer, explain benefits, recommend suitable product.', 'SALES');
...
UPDATE wiki_article SET display_order = 1 WHERE article_id = 2;
UPDATE wiki_article SET display_order = 2 WHERE article_id = 3;
UPDATE wiki_article SET display_order = 3 WHERE article_id = 4;
UPDATE wiki_article SET display_order = 4 WHERE article_id = 28;
UPDATE wiki_article SET display_order = 5 WHERE article_id = 30;
UPDATE wiki_article SET display_order = 6 WHERE article_id = 29;
UPDATE wiki_article SET display_order = 7 WHERE article_id = 30;
UPDATE wiki_article SET display_order = 8 WHERE article_id = 35;
UPDATE wiki_article SET display_order = 9 WHERE article_id = 36;
UPDATE wiki_article SET display_order = 10 WHERE article_id = 37;
UPDATE wiki_article SET display_order = 11 WHERE article_id = 38;
UPDATE wiki_article SET display_order = 12 WHERE article_id = 39;
UPDATE wiki_article SET display_order = 13 WHERE article_id = 40;
UPDATE wiki_article SET display_order = 14 WHERE article_id = 41;
UPDATE wiki_article SET display_order = 15 WHERE article_id = 42;
...
UPDATE wiki_article
SET title = 'Kiosk Closing Check List'
WHERE article_id = 2;
...
-- =========================
-- INSERT DATA (VERY IMPORTANT)
-- =========================
INSERT INTO wiki_article (title, content, category) VALUES
('Kiosk Closing Check List', 'Check stock...', 'SOP'),
('Aeon Roadshow Closing List', 'Steps...\nClick >>> Jerry Can Stocktake Guide', 'SOP'),
('Aeon Roadshow Opening List', 'Info...', 'SOP'),
('JHKC Kiosk Opening', 'Tips...', 'SOP');
